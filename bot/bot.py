...
bot = telebot.TeleBot(bash("grep TELEGRAM_BOT_TOKEN /var/cld/creds/creds | cut -d = -f 2").strip())
api_domain = bash("grep CLD_DOMAIN /var/cld/creds/creds | cut -d = -f 2").replace('\n', '')
